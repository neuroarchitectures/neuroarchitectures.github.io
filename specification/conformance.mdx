...
|---------|------|---------|
| 1.0 | 2026-09-23 | Initial public draft. Includes block templates ([§25](/specification/block-templates#25-block-templates-and-repetition)): reusable subgraph definitions, `block_ref` components, `repeat` directives for layer/block repetition, parameter binding, and scope index substitution. |
